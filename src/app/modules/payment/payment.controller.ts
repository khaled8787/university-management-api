...
export const getMyPaymentByIdController =
  catchAsync(
    async (
      req: Request,
      res: Response,
...
export const getAdminPaymentByIdController =
  catchAsync(
    async (
      req: Request,
      res: Response,
      ...
      const result =
        await getPaymentByIdForAdmin(id);
...
export const cancelPaymentController =
  catchAsync(
    async (
      req: Request,
      res: Response,
